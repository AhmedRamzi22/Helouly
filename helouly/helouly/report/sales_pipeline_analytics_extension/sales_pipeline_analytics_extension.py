...
class SalesPipelineAnalytics(object):
    ...
    def set_pipeline_based_on_column(self):
        if self.filters.get("pipeline_by") == "Owner":
            self.columns.insert(0, {"fieldname": "opportunity_owner", "label": _("Opportunity Owner"), "width": 200})
    ...
    def get_fields(self):
        ...
        self.group_by_based_on = {"Owner": "_assign", "Sales Stage": "sales_stage"}[self.filters.get("pipeline_by")]
        ...
        self.pipeline_by = {"Owner": "opportunity_owner", "Sales Stage": "sales_stage"}[self.filters.get("pipeline_by")]
    ...
    def get_conditions(self):
        ...
        if self.filters.get("sales_partner"):
            conditions.append({"sales_partner": self.filters.get("sales_partner")})
    ...
    def get_periodic_data(self):
        ...
        pipeline_by = {"Owner": "opportunity_owner", "Sales Stage": "sales_stage"}[self.filters.get("pipeline_by")]
